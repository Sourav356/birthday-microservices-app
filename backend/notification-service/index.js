...
cron.schedule('0 0 * * *', async () => {
  ...
  try {
    const res = await axios.get('http://localhost:3002/today'); // call birthday-service
    ...
    for (const user of birthdays) {
      await transporter.sendMail({
        ...
        subject: '🎉 Happy Birthday!',
        html: `<h1>Happy Birthday!</h1><p>Click <a href="http://localhost:5173/celebration">here</a> to see your surprise 🎂</p>`
      });
